...
YELLOW_SPACEPSHP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACEPSHIP_IMAGE,(95,70)), 270)
RED_SPACEPSHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'spaceship_red.png'))
RED_SPACEPSHP = pygame.transform.rotate(pygame.transform.scale(RED_SPACEPSHIP_IMAGE, (95,70)), 90)
